...
# Symptoms dictionary and diseases list (same as provided)
...
def home():
    if request.method == 'POST':
        ...
        # Validate that the input symptoms are in the dictionary
        ...
        return render_template('index.html', predicted_disease=predicted_disease, dis_des=dis_des,
                               my_precautions=my_precautions, medications=medications, my_diet=rec_diet, workout=workout)
